/** @file
 *    @brief MAVLink comm protocol testsuite generated from chibi.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef CHIBI_TESTSUITE_H
#define CHIBI_TESTSUITE_H
...
static void mavlink_test_chibi(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_chibi(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_chibi(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

/** @file
 *	@brief MAVLink comm testsuite protocol generated from chibi.xml
...
TEST(chibi, HEARTBEAT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::chibi::msg::HEARTBEAT packet_in{};
    packet_in.type = 17;
    ...
    mavlink::chibi::msg::HEARTBEAT packet1{};
    mavlink::chibi::msg::HEARTBEAT packet2{};
...
TEST(chibi, ATTITUDE)
{
    ...
    mavlink::chibi::msg::ATTITUDE packet_in{};
    ...
    mavlink::chibi::msg::ATTITUDE packet1{};
    mavlink::chibi::msg::ATTITUDE packet2{};
...
TEST(chibi, ATTITUDE_QUATERNION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::chibi::msg::ATTITUDE_QUATERNION packet_in{};
    packet_in.time_boot_ms = 963497464;
    packet_in.q1 = 45.0;
    packet_in.q2 = 73.0;
    packet_in.q3 = 101.0;
    ...
    mavlink::chibi::msg::ATTITUDE_QUATERNION packet1{};
    mavlink::chibi::msg::ATTITUDE_QUATERNION packet2{};
...
#ifdef TEST_INTEROP
TEST(chibi_interop, ATTITUDE_QUATERNION)
{
    mavlink_message_t msg;
...
TEST(chibi, LOCAL_POSITION_NED)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::chibi::msg::LOCAL_POSITION_NED packet_in{};
    packet_in.time_boot_ms = 963497464;
    packet_in.x = 45.0;
    packet_in.y = 73.0;
    packet_in.z = 101.0;
    ...
    mavlink::chibi::msg::LOCAL_POSITION_NED packet1{};
    mavlink::chibi::msg::LOCAL_POSITION_NED packet2{};
...
#ifdef TEST_INTEROP
TEST(chibi_interop, LOCAL_POSITION_NED)
{
    mavlink_message_t msg;
...
TEST(chibi, SET_ATTITUDE_TARGET)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::chibi::msg::SET_ATTITUDE_TARGET packet_in{};
    packet_in.time_boot_ms = 963497464;
    ...
    mavlink::chibi::msg::SET_ATTITUDE_TARGET packet1{};
    mavlink::chibi::msg::SET_ATTITUDE_TARGET packet2{};
...
#ifdef TEST_INTEROP
TEST(chibi_interop, SET_ATTITUDE_TARGET)
{
    mavlink_message_t msg;

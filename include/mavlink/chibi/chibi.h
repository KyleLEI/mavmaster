/** @file
 *  @brief MAVLink comm protocol generated from chibi.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_CHIBI_H
#define MAVLINK_CHIBI_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_CHIBI.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
